...
//   fds.forEach((f, idx) => {
//     if (f.type === 'text') {
//       obj[f.name] = $(f.path).text()
//     }
//     if (f.type === 'image') {
//       obj[f.name] = $(f.path).attr('src')
//     }
//     if (f.type === 'link') {
//       obj[f.name] = $(f.path).attr('href')
//     }
//   })
//   return obj
// }
...
//           return obj
//         })
//         await jsonfile.writeFile('./tmp/test.json', ob, {
//           flag: 'a'
//         }, function (err) {
//           console.error(err)
//         })
...
new Builder(nuxt).build()
  .then(function () {
    ...
    app.listen(3005, '0.0.0.0', function () {
      console.log('--nospider------listen', 3005, '------', config.dev);
    });
  })
  .catch((error) => {
    console.error(error)
